document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('scroll', () => {
        ...
        // Example condition to change background color based on scroll position
        if (scrollPosition > window.innerHeight) {
            aboutMeSection.style.backgroundColor = 'black';
        } else {
            aboutMeSection.style.backgroundColor = '';
        }
    });
});
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initHeader() {
        ...
        if (!canvas) {
            console.error('Element with id "demo-canvas" not found.');
            return;
        }
        canvas.width = width;
